...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 10 2019 г., 03:03
...
(1, 1, '2019-09-02', 'Не был(а)', 1),
(1, 1, '2019-09-04', 'Не был(а)', 1),
(1, 1, '2019-12-03', 'Не был(а)', 1),
(1, 1, '2019-12-04', 'Был(а)', 1),
(1, 1, '2019-12-05', 'Был(а)', 1),
(1, 1, '2019-12-06', 'Был(а)', 1),
(1, 1, '2019-12-09', 'Был(а)', 1),
(1, 1, '2019-12-10', 'Был(а)', 1),
(1, 1, '2019-12-11', 'Был(а)', 1),
(1, 1, '2019-12-12', 'Был(а)', 1),
(1, 1, '2019-12-13', 'Был(а)', 1),
(1, 2, '2020-04-27', 'Был(а)', 1),
(1, 2, '2020-04-28', 'Был(а)', 1),
(1, 2, '2020-04-30', 'Был(а)', 1),
(1, 2, '2020-05-01', 'Был(а)', 1),
(1, 3, '2019-09-03', 'Был(а)', 1),
(1, 3, '2019-12-09', 'Не был(а)', 1),
(2, 1, '2019-09-02', 'Не был(а)', 1),
(2, 1, '2019-09-17', 'Не был(а)', 1),
(2, 1, '2019-12-06', 'Был(а)', 1),
(2, 1, '2019-12-09', 'Не был(а)', 1),
(2, 1, '2019-12-13', 'Не был(а)', 1),
(2, 2, '2020-05-01', 'Был(а)', 1),
(3, 1, '2019-12-06', 'Был(а)', 3),
(3, 3, '2019-12-06', 'Не был(а)', 1),
(3, 3, '2019-12-12', 'Был(а)', 1),
(3, 3, '2019-12-13', 'Был(а)', 1),
(3, 4, '2019-12-06', 'Был(а)', 2),
(4, 1, '2019-12-03', 'Был(а)', 3),
(4, 3, '2019-12-06', 'Был(а)', 1),
(4, 4, '2019-12-05', 'Не был(а)', 2),
(4, 4, '2019-12-09', 'Не был(а)', 2),
(4, 4, '2019-12-13', 'Был(а)', 2),
