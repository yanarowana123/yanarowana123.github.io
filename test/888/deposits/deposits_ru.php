...
?>
<h2 class="with-breaker animate-me fadeInLeft animated animated" style="visibility: visible; animation-name: fadeInLeft;">
		  			<i class="fa fa-bar-chart"></i>Мои вклады
	  			</h2>
<table width="760px" align="right">
<?php
$s = 0;
...
print "<tr>
	<td><div style=\"padding: 4px; background-color: #6495ed;\"><b>".$row2['name']."</b> - Сумма: <b>$".$row['sum']."</b>";
