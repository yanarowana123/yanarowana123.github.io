...
function PrintRef($refid, $i, $c) {
	...
	$rs		= mysql_query($sql);
		...
		while($a = mysql_fetch_array($rs)) {
			...
			if($i == 1) {
				...
				print "<tr bgcolor=\"#6495ed\" align=\"center\"><td>".$n."</td><td align=\"left\">".$a['login']."</font></td><td align=\"left\">".$a['icq']."</font></td><td align=\"left\">".$a['skype']."</font></td><td>".$a['ref_money']."</td></tr>";
				...
				print "<tr bgcolor=\"#6495ed\" align=\"center\"><td></td><td align=\"left\" style=\"padding-left: ".$i."0px;\"><font color=\"#999999\">» ".$a['login']." ".$a['icq']."".$a['skype']."</font></td><td>-</td></tr>";
	...
	if(mysql_num_rows($rs)) {
		...
		print "<tr align=\"center\" bgcolor=\"#6495ed\"><td><td></td></td><td align=\"right\" colspan=\"2\" style=\"padding: 3px;\"><b>Всего:</b></td><td><b>".sprintf("%01.2f", $m)."</b></td></tr>";

	} else {
		print "<tr bgcolor=\"#6495ed\"><td colspan=\"3\" align=\"center\">Вы пока никого не пригласили!</td></tr>";
	}
