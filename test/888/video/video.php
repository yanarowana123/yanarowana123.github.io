...
// Добавление отзыва
	...
	if (!$title) {
		print '<div class="alert alert-fixed alert-warning alert-dismissible" role="alert">
								  ...
								  <p class="alert__text"> Specify the name of the video.</p>
								</div>';
	} elseif (!$link) {
		print '<div class="alert alert-fixed alert-warning alert-dismissible" role="alert">
								  <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true"><i class="pe-7s-close"></i></span><span class="sr-only">Close</span></button>
								  ...
								  <p class="alert__text"> Enter the Youtube video ID!</p>
								</div>';
		...
		print '<div class="alert alert-fixed alert-warning alert-dismissible" role="alert">
								  ...
								  <p class="alert__text"> To offer video is possible only once an hour!</p>
								</div>';
	} else {
...
print '<div class="alert alert-fixed alert-success alert-dismissible" role="alert">
								  ...
								  <p class="alert__text"> You have successfully sent the video for moderation,thank you for your cooperation!</p>
								</div>';
	}
}
	} else {
...
function topics_list($page, $num, $status)
{
	...
	print'<header class="widget__header one-btn">
								<div class="widget__title" style=" width: 100%;">
									<i class="pe-7f-film"></i><h3>Video reviews</h3>
								</div>
							</header>';
...
<table bgcolor="#eeeeee" width="100%" align="center" border="0" style="width: 100%;">
	<tr class="widget__form">
		<td align="right"><input class="inp" placeholder="Video name:" type="text" name="titleer" size="97" /></td>
	</tr>
	<tr class="widget__form">
		<td align="right"><input class="inp" placeholder="Link video Youtube(ID) - Vz3pdjd8So8" type="text" name="linker" maxlength="250" /></td>
</table>
<table align="center" width="100%" border="0">
	<tr>
		<td align="right"><button type="submit" style="width:100%; margin: 2px 0 0 0;" class="btn green fixed">To offer</button></td>
	</tr>
</table>
</form>
</table>
...
<?php
	...
	print '<div class="alert alert-fixed alert-danger alert-dismissible" role="alert">
								  ...
								  <p class="alert__text">To add video reviews, you must login!</p>
								</div>';
}
?>