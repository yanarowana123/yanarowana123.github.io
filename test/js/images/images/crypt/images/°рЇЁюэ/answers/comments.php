		...
		if (!$_POST['text'] || $_POST['text'] == " ") {
			...
			if (!$text || $text == " ") {
				...
				print '<div class="alert alert-fixed alert-danger alert-dismissible" role="alert">
								  ...
								  <p class="alert__text">The comment cannot be added more than once in 5 minutes.</p>
								</div>';
			} else {
				...
				if (mysql_query($sql)) {
					print '<div class="alert alert-fixed alert-success alert-dismissible" role="alert">
								  ...
								  <p class="alert__text">Comment added on!</p>
								</div>';
...
print ' <br>'.$admin_but.'</p></td><td style="vertical-align: middle;'.$styleback.'">
		...
		if($row['answer']) { print "<div style='border: 2px solid rgba(146, 145, 143, 0.48); background-color: rgba(140, 156, 173, 0.18); padding: 3px;border-radius: 12px;margin-top: 9px;'><i style=\"color: rgba(255, 255, 255, 0.37);\">Comment from the administration:</i><br /><font style=\"color: rgb(197, 197, 197);\">".$row['answer']."</font></div>"; }
...
print '<header class="widget__header one-btn">
								<div class="widget__title" style=" width: 100%;">
									<i class="pe-7f-comment"></i><h3>Comments to the review</h3>
								</div>
							</header>';
...
function topics_list($page, $num, $status)
{
	...
	if(!$themes) {
		print '<div class="alert alert-fixed alert-danger alert-dismissible" role="alert">
								  ...
								  <p class="alert__text"> To this review no comments.</p>
								</div>';
	}
...
<table width="100%" border="0" align="center">
	...
	<tr>
		<td colspan="1"><textarea placeholder="Message..." style="min-width: 278px; width: 100%; background: rgba(0,0,0,0.25);" name="text" rows="7" cols="48"><?php print htmlspecialchars(substr($_POST['text'], 0, 10000), ENT_QUOTES, ''); ?></textarea></td>
	</tr>
	<tr>
...
<?php
			...
			print '<div class="alert alert-fixed alert-danger alert-dismissible" role="alert">
								  ...
								  <p class="alert__text"> To add a comment you need to login!</p>
								</div>';
		}
		...
		print '<div class="alert alert-fixed alert-danger alert-dismissible" role="alert">
								  ...
								  <p class="alert__text"> Review not found!</p>
								</div>';
	}
?>