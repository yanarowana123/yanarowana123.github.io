...
if ($login) {
	if ($_GET['action'] == 'save') {
		...
		if (!$email) {
			echo '<p class="er">You should enter the E-mail!</p>';
		} else {
			if ($pass_1 != $pass_2) {
				echo '<p class="er">The password and confirmation do not match!</p>';
			} else {
				if (!preg_match("/^[a-z0-9_.-]{1,20}@(([a-z0-9-]+\.)+(com|net|org|mil|edu|gov|arpa|info|biz|[a-z]{2})|[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3})$/is", $email)) {
					print '	<div class="alert alert-fixed alert-warning alert-dismissible" role="alert">
								  ...
								  <p class="alert__text">Enter the correct e-mail</p>
								</div>';
					...
					print '<div class="alert alert-fixed alert-warning alert-dismissible" role="alert">
								  ...
								  <p class="alert__text">Enter the correct PM wallet!</p>
								</div>';
					...
					print '<div class="alert alert-fixed alert-warning alert-dismissible" role="alert">
								  ...
								  <p class="alert__text">Enter a valid Bitcoin wallet!</p>
								</div>';
				} elseif ($pm[0] != 'U' && $pm) {
					print '<div class="alert alert-fixed alert-warning alert-dismissible" role="alert">
								  <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true"><i class="pe-7s-close"></i></span><span class="sr-only">Close</span></button>
					...
					print '<div class="alert alert-fixed alert-warning alert-dismissible" role="alert">
								  ...
								  <p class="alert__text">Such a PM was already in the system!</p>
								</div>';
					...
					print '<div class="alert alert-fixed alert-warning alert-dismissible" role="alert">
								  ...
								  <p class="alert__text">Such Payeer is already in the database!</p>
								</div>';
					...
					print '<div class="alert alert-fixed alert-warning alert-dismissible" role="alert">
								  ...
								  <p class="alert__text">This Bitcoin already exist in the database!</p>
								</div>';
					...
					if (mysql_query($sql)) {
						print '<div class="alert alert-fixed alert-success alert-dismissible" role="alert">
								  ...
								  <p class="alert__text">Data has been successfully updated!</p>
								</div>';
					} else {
						print '<div class="alert alert-fixed alert-warning alert-dismissible" role="alert">
								  <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true"><i class="pe-7s-close"></i></span><span class="sr-only">Close</span></button>
								  ...
								  <p class="alert__text">Cant change the data</p>
								</div>';
					}
			}
		}
...
<table align="center" width="100%" border="0" cellpadding="2" cellspacing="1" class="widget__form" style="position: relative; left: calc(-25% - 15px);">
	<tr>
		<td style="padding-right: 10px; vertical-align:middle;" align="right" width="20%" >Password: </td>
		<td align="left" width="20%"><input type='password' name='pass_1' size="30" /></td>
	</tr>
	<tr>
		<td style="padding-right: 10px; vertical-align:middle;" align="right" width="20%" >Repeat password:</td>
	...
	<tr>
		<td style="padding-right: 10px; vertical-align:middle;" align="right" width="20%" >Phone:</td>
...
<div align="center" style="padding-top: 10px;"><button type="submit" style="width:220px; margin: 2px 0 0 0;" class="btn green fixed">Save</button></div>
