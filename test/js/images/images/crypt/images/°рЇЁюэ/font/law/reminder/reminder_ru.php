...
<form action="?action=send" method=post>
	<tr>
		<td><strong><center>Введите логин</center></strong> </td>
	</tr>
	<tr>
		<td><input style="width: 243px;" type="text" name="ulogin" size="30" maxlength="30" /></td>
	</tr>
	<tr>
		<td><strong><center> Введите E-mail</center></strong></td>
	</tr>
	<tr>
	...
	<tr>
		<td>
			<table align="center" cellpadding="1" cellspacing="1" border="2"><br>
					...
					<input  class="button"style="width: 245px; "  type="submit" value=" Отправить " />
