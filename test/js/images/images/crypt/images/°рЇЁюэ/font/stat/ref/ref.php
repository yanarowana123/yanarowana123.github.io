...
defined('ACCESS') or die();
	...
	if($ref) {
		...
		if($upicq) {
			print " <p>ICQ Curator: ".$upicq."</p>";}
        if($upskype) {
			print "<p>Skype Curator:  ".$upskype."</p>";}
...
<div class="col-md-8" style=" width: 100%; margin-top: -14px;">
						<article class="widget">
							<header class="widget__header one-btn">
								<div class="widget__title" style=" width: 100%;">
									<i class="pe-7s-network"></i><h3>Referrals invited by you</h3>
								</div>
							</header>
	...
	<thead>
		<?php if($ref) {?><tr style="background-color: rgba(0, 0, 0, 0.25); border-bottom: 1px transparent solid;" bgcolor="#ffffff"><td colspan="4" align="center">You are invited: <?php print $uplogin;?> </b></td></tr><?php }?>
	<tr style="background-color: rgba(0, 0, 0, 0.25); border-bottom: 1px transparent solid;" bgcolor="#ffffff"><td colspan="4" align="center">Your affiliate link: http://<?php print $cfgURL; ?>/?ref=<?php print $login; ?></td></tr>
							  		<tr>
<th>#</th>
<th>Login</th>
<th>Skype</th>
...
$sqlr	= 'SELECT id, sum FROM reflevels WHERE id = '.$refl;
	...
	if(mysql_num_rows($rs)) {
		...
		print "<tr style=\"background-color: transparent;\" align=\"center\" bgcolor=\"#dddddd\"><td><td></td></td><td align=\"right\" colspan=\"1\" style=\"padding: 3px;\"><b>Total:</b></td><td><b>".sprintf("%01.2f", $m)."</b></td></tr>";

	} else {
		print "<tr style=\"background-color: transparent;\" bgcolor=\"#ffffff\"><td colspan=\"5\" align=\"center\">You while no one was invited!</td></tr>";
	}
