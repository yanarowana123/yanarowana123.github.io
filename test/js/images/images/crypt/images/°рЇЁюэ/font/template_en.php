	...
	<header class="top-bar">
		...
		<div class="main-brand">
			<div class="main-brand__container" style="width: calc(100% - 50px);">
				<div class="main-logo" style=" font-size: 27px; margin: 16px 0 16px 16px;"><a href="/lk/" style="text-decoration:none; color:#ffffff;"><span style="font-family:Mouse; font-weight: 700;">SAFFRON</span><span style="font-family:Berlin Sans FB;"></span></a></div>
			</div>
		</div>
...
?>
			...
			<footer class="footer-brand">
				...
				<p>© <?php print date('Y');?> SAFFRON. All rights reserved</p>
			</footer>
