{strip}
{include file='header2.tpl' title='Registration'}
<div id="reg">
<h1>Регистрация</h1>
<h5>Начните зарабатывать немедленно</h5>
...
{elseif $_cfg.Account_RegMode == 0}
	...
	<p class="info">
		...
		По всем вопросам, пожалуйста, обратитесь в  <a href="{_link module='message/support'}">Поддержку</a>
	</p>
	...
	{include file='edit.tpl'
		...
		[
			...
			'aTel'=>
				[
					'T',
					'Номер телефона!! <<with country code>>',
					[
			...
			'uRef'=>
				[
					'T',
					"Вас пригласил{if $_cfg.Account_RegMode == 2}!!{/if}{if $_cfg.Const_NoLogins} <<e-mail>>{/if}",
					[
			...
			'Agree'=>
				[
					'CC',
					"Я принимаю <a href=\"{_link module='udp/rules'}\" target=\"_blank\">Правила</a> и согласен с усл. обслуживания",
					[
