...
table_class=' table table-operations table tbl-style'
	fields=[
		'oID'=>[],
		'oState'=>
			[
...
<div class="box">
<h3>Our payment details <br/><small>(to pay manually through {$el.cName})</small></h3>


		<table class="table  list-items table-list" style='margin-top:10px;'>
