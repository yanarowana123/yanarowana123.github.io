...
<html>
	<head>
		...
		<base href="{$root_url}" />
        <link rel="stylesheet" type="text/css" href="{$img_path}style_cab.css">
        ...
        <!--[if IE 9]>
            <link href="{$img_path}ie9.css" type="text/css" rel="stylesheet" />    
        <![endif]-->   
        <!--[if IE 8]>
            <link href="{$img_path}ie8.css" type="text/css" rel="stylesheet" />    
        <![endif]-->
        <!--[if IE 7]>
            <link href="{$img_path}ie7.css" type="text/css" rel="stylesheet" />    
        <![endif]-->
