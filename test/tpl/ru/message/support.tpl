            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-6">
						...
						{literal}			<!-- GTranslate: https://gtranslate.io/ -->
                        ...
                        <div class="rp_mobail_menu_main_wrapper visible-xs">
                            ...
                            <div id="sidebar">
                                ...
                                <div id="cssmenu" class="wd_single_index_menu">
                                    <ul>
                                        <li class="active"><a href="#">Главная</a></li>
                                        <li class=""><a href="http://cv18136.tmweb.ru/#abt">О насt</a></li>
                                        <li class=""><a href="http://cv18136.tmweb.ru/#fea">Особенности</a></li>
                                        <li class=""><a href="http://cv18136.tmweb.ru/#pro">Проект</a></li>
                                        <li class=""><a href="http://cv18136.tmweb.ru/#stp">Меры</a></li>
                                        <li class=""><a href="http://cv18136.tmweb.ru/#road">Дорожная карта</a></li>
                                        <li class=""><a href="http://cv18136.tmweb.ru/#token">Условия</a></li>
                                        <li class=""><a href="http://cv18136.tmweb.ru/#news">Контакты</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        <div class="item active">
							...
							<div id="supp">
   <center> <h1>Форма поддержки</h1>
   <center> <h2>Заполните форму, чтобы связаться с нами</h2>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="section-heading">
                            <h2 class="wow  fadeInUp  animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">Press (Media)</h2>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="section-heading2">
                                <h2 class="wow  fadeInUp  animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">Core Team</h2>
                            </div>
                        </div>
                    </div>
                    <div class="row">
        ...
        <section class="team2-area pd-t100 pd-b50 bg-img">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="section-heading">
                            <h2 class="wow  fadeInUp  animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">Our Advisors</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
