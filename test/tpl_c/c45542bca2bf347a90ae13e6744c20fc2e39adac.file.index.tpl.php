...
<!-- Mirrored from themes.hyipsoftware.com/standard-templates/bitmoney/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Sep 2019 05:43:15 GMT -->
<head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8"><style class="vjs-styles-defaults">
	...
	<script src="https://use.fontawesome.com/3e9b2663b4.js"></script>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>MyTopWorld</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="apple-touch-icon" href="/webstrot.com/html/tm/ico/landing_page_dark/apple-touch-icon.html">
...
<body>
    ...
    <div id="preloader" style="display: none;">
        <div id="status" style="display: none;"><img src="img/loader.gif" id="preloader_image" alt="loader">
        </div>
    </div>
                        ...
                        <div class="menu-area  hidden-xs">
                            <nav class="wd_single_index_menu btc_main_menu">
                                <ul>
                                    ...
                                    <li class=""><a href="#abt">О нас</a></li>
                                    <li class=""><a href="#fea">Особенности</a></li>
                                    <li class=""><a href="#pro">Проект</a></li>
                                    <li class=""><a href="#stp">Меры</a></li>
                                    <li class=""><a href="#road">Дорожная карта</a></li>
                                    <li class=""><a href="#token">Условия</a></li>
                                    <li class=""><a href="/support">Контакты</a></li>
									
									
									
									
									<!-- GTranslate: https://gtranslate.io/ -->
<a href="#" onclick="doGTranslate('ru|en');return false;" title="English" class="gflag nturl" style="background-position:-0px -0px;"><img src="//gtranslate.net/flags/blank.png" height="32" width="32" alt="English" /></a><a href="#" onclick="doGTranslate('ru|it');return false;" title="Italian" class="gflag nturl" style="background-position:-600px -100px;"><img src="//gtranslate.net/flags/blank.png" height="32" width="32" alt="Italian" /></a><a href="#" onclick="doGTranslate('ru|pt');return false;" title="Portuguese" class="gflag nturl" style="background-position:-300px -200px;"><img src="//gtranslate.net/flags/blank.png" height="32" width="32" alt="Portuguese" /></a><a href="#" onclick="doGTranslate('ru|ru');return false;" title="Russian" class="gflag nturl" style="background-position:-500px -200px;"><img src="//gtranslate.net/flags/blank.png" height="32" width="32" alt="Russian" /></a><a href="#" onclick="doGTranslate('ru|es');return false;" title="Spanish" class="gflag nturl" style="background-position:-600px -200px;"><img src="//gtranslate.net/flags/blank.png" height="32" width="32" alt="Spanish" /></a>
<a href="#" onclick="doGTranslate('ru|kk');return false;" title="Kazakh" class="gflag kk nturl" style="background-image: none !important;margin-bottom: 2px !important;"><img src="//gtranslate.io/shopify/assets/flags/32/kk.png" height="32" width="32" alt="Kazakh" /></a>
<style type="text/css">
<!--
a.gflag {display: inline-flex;vertical-align:middle;font-size:32px;padding:1px 0;background-repeat:no-repeat;background-image:url(//gtranslate.net/flags/32.png);}
...
/* ]]> */
                            ...
                            <div class="login-btn">
							  ...
							  <?php if (_uid()){?>
                                <a href="cabinet" class="btn1"><i class="fa fa-user"></i><span>Кабинет</span></a>         
								
								
								  <a href="login?out" class="btn1"><i class="fa fa-user"></i><span>Выход</span></a>
								 <?php }else{ ?>
								
								    <a href="registration" class="btn1"><i class="fa fa-user"></i><span>Присоединиться</span></a>         
								
								
								  <a href="login" class="btn1"><i class="fa fa-user"></i><span>Войти</span></a>
                        ...
                        <div class="rp_mobail_menu_main_wrapper visible-xs">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div id="toggle">
                                        <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 31.177 31.177" style="enable-background:new 0 0 31.177 31.177;" xml:space="preserve" width="25px" height="25px">
                                            <g>
                                                <g>
...
ul.submenu > li > a:hover {
    text-decoration: underline;
                            ...
                            <div id="sidebar">
                                <h1><a href="#">MyTopWorld</a></h1>
                                <div id="toggle_close">×</div>
                                <div id="cssmenu" class="wd_single_index_menu">
                                    <ul>
                                        <li class="active"><a href="#">Главная</a></li>
                                        <li class=""><a href="#abt">О насt</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <div class="slider-content">
                                                ...
                                                <h2 data-animation="animated bounceInLeft" class="">MTW - Кредитно &amp; <br>инвестиционная платформа</h2>
                                                <div class="buttons">
												
												  <?php if (_uid()){?>
                <a href="cabinet" class="btn1" data-animation="animated bounceInUp">Кабинет</a>
                                                    <a href="/login?out" class="btn2" data-animation="animated bounceInUp">Выход</a>
                    <?php }else{ ?>
                 <a href="registration" class="btn1" data-animation="animated bounceInUp">Присоединиться</a>
                                                    <a href="/login" class="btn2" data-animation="animated bounceInUp">Войти</a>
                    <?php }?>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="slider-content">
                                            ...
                                            <h2 data-animation="animated bounceInLeft">MyTopWorld - Lending &amp; <br>Инвестиционная платформа</h2>
                                            <div class="buttons">
                                            							  <?php if (_uid()){?>
                <a href="cabinet" class="btn1" data-animation="animated bounceInUp">Кабинет</a>
                                                    <a href="/login?out" class="btn2" data-animation="animated bounceInUp">Выход</a>
            ...
            <div class="container-fliud">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="rete-list bt_title wow  fadeInUp  animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">
                            <div class="content">
                                <div class="con">
                                    <h2><img src="img/1_003.png" alt=""><span>Bitcoin</span></h2>
                        ...
                        <div class="rete-list bt_title wow  fadeInUp  animated" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 1.3s; animation-name: fadeInUp;">
                            <div class="content">
                                <div class="con">
                                    <h2><img src="img/2_005.png" alt=""><span>Ethereum</span></h2>
                        ...
                        <div class="rete-list bt_title wow  fadeInUp  animated" data-wow-duration="1.6s" style="visibility: visible; animation-duration: 1.6s; animation-name: fadeInUp;">
                            <div class="content">
                                <div class="con">
                                    <h2><img src="img/3_003.png" alt=""><span>Dollar (USD)</span></h2>
                        ...
                        <div class="rete-list bt_title wow  fadeInUp  animated" data-wow-duration="1.9s" style="visibility: visible; animation-duration: 1.9s; animation-name: fadeInUp;">
                            <div class="content">
                                <div class="con">
                                    <h2><img src="img/4_003.png" alt=""><span>Total USD</span></h2>
                        ...
                        <div class="rete-list hidden-md   wow  fadeInUp  animated" data-wow-duration="2.1s" style="visibility: visible; animation-duration: 2.1s; animation-name: fadeInUp;">
                            <div class="content">
                                <div class="con">
                                    <h2><img src="img/5_002.png" alt=""><span>Token Sale</span></h2>
    ...
    <div section-scroll="1" class="wd_scroll_wrap" id="abt">
        <section class="about-area pd-t70 pd-b100 jarallax bg-img">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="about-content">
                            <h2 class="f-40 fw-400 wow  fadeInUp  animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">О нас</h2>
                            <p class="wow  fadeInUp  animated" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 1.3s; animation-name: fadeInUp;">MyTopWorld - это мультивалютная и многофункциональная онлайн-платформа для кредитования и инвестиций, основанная на технологии блокчейна. Здесь участниуи имеют возможность заработать на криптовалютах которые только выходят на рынок и начинают свою жизнь.</p>
                            <p class="wow  fadeInUp  animated" data-wow-duration="1.6s" style="visibility: visible; animation-duration: 1.6s; animation-name: fadeInUp;">MyTopWorld - это уникальная услуга, которая позволяет физическим лицам получать доступ к инвециям, не выходя из своего дома в необязательных валютах или криптовалютах.</p>
                            <p class="wow  fadeInUp  animated" data-wow-duration="1.9s" style="visibility: visible; animation-duration: 1.9s; animation-name: fadeInUp;">MyTopWorld -
 это многофункциональная платформа, которая позволяет каждому участнику хранить деньги в мультивалютном онлайн-кошельке, зарабатывать на  покупках и продажах валюты на бирже, вкладывать деньги, получать дивиденды в удобное время.</p>
                            <div class="buttons">
								   ...
								   <a href="cabinet" class="btn1">Кабинет</a>
                                <a href="login?out" class="btn3">Выход</a>
								 <?php }else{ ?>
								
									   <a href="registration" class="btn1">Присоединиться</a>
                                <a href="login" class="btn3">Войти</a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="about-img wow  fadeInUp  animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">
        ...
        <!--About area end here-->
        <div class="sud">
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1920 181.1" style="enable-background:new 0 0 1920 181.1;" xml:space="preserve">
                <style type="text/css">
                    .st0 {
                        fill-rule: evenodd;
                        clip-rule: evenodd;
    ...
    <div section-scroll="2" class="wd_scroll_wrap" id="fea">
        <section class="features-area section">
            <div id="features-js">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="section-heading2 wow  fadeInUp  animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">
                                ...
                                <ul>
                                    <li>
                                        <div class="col-sm-6 pd-0 hidden-xs wow  fadeInUp  animated" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 1.3s; animation-name: fadeInUp;">
                                            <div class="contents-l mr-b30">
                                                <h2>Ваши деньги работают</h2>
                                                <p>Мы сделали лучшую криптовалютную платформу. Команда профефионалов работают
                                                    <br>а вы получаете дивиденды.</p>
													
													
													
                                                <a href="about" class="btn1">Подробнее</a>
                                        ...
                                        <div class="col-sm-6 pd-0 wow  fadeInUp  animated" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 1.3s; animation-name: fadeInUp;">
                                            <div class="imgs-l">
                                                <figure><img src="img/1_004.png" alt=""></figure>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 pd-0 visible-xs  wow  fadeInUp animated animated" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 1.3s; animation-name: fadeInUp;">
                                            <div class="contents-l mr-b30">
                                                <h2>Lending</h2>
                                                <p>Unique platform for lending and investment with a safety fund
                                                    <br>and cooperation with world-wide arbitration.</p>
                                             	
                                                <a href="about" class="btn1">О нас</a>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="rl">
                                        <div class="col-sm-6 pd-0 floatright mr-b30 hidden-xs wow  fadeInUp  animated" data-wow-duration="1.6s" style="visibility: visible; animation-duration: 1.6s; animation-name: fadeInUp;">
                                            <div class="contents-r">
                                                ...
                                                <p>Вы можете воспользоваться разными валютными системами что бы присоединиться к нашей команде.
                                                    <br>Мы постоянно добавляем новые возможности для наших партнеров.</p>
                                           	
                                                <a href="about" class="btn1">Пдробнее</a>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 pd-0 wow  fadeInUp  animated" data-wow-duration="1.6s" style="visibility: visible; animation-duration: 1.6s; animation-name: fadeInUp;">
                                            <div class="imgs-r">
                                                <figure><img src="img/2_002.png" alt=""></figure>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 pd-0 floatright mr-b30 visible-xs wow  fadeInUp animated animated" data-wow-duration="1.6s" style="visibility: visible; animation-duration: 1.6s; animation-name: fadeInUp;">
                                            <div class="contents-r">
                                    ...
                                    <li>
                                        <div class="col-sm-6 pd-0 hidden-xs wow  fadeInUp  animated" data-wow-duration="1.9s" style="visibility: visible; animation-duration: 1.9s; animation-name: fadeInUp;">
                                            <div class="contents-l mr-b30">
                                                <h2>Инвестиции</h2>
                                                <p>Улучшеная система начислений и переводов. Всегда
                                                    <br>лучшие условия для наших партнеров.</p>
                                        ...
                                        <div class="col-sm-6 pd-0 wow  fadeInUp  animated" data-wow-duration="1.9s" style="visibility: visible; animation-duration: 1.9s; animation-name: fadeInUp;">
                                            <div class="imgs-l">
                                                <figure><img src="img/3_005.png" alt=""></figure>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 pd-0 visible-xs wow  fadeInUp animated animated" data-wow-duration="1.9s" style="visibility: visible; animation-duration: 1.9s; animation-name: fadeInUp;">
                                            <div class="contents-l mr-b30">
                                                <h2>Investment</h2>
                                    ...
                                    <li class="rl">
                                        <div class="col-sm-6 pd-0 floatright mr-b30 hidden-xs wow  fadeInUp  animated" data-wow-duration="2.1s" style="visibility: visible; animation-duration: 2.1s; animation-name: fadeInUp;">
                                            <div class="contents-r">
                                                <h2>Кошелек онлайн</h2>
                                                <p>Создание собственной платежной системы от 
                                                    <br>MyTopWorld в течении 2020 года.</p>
                                                	
                                                <a href="" class="btn1">Скоро</a>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 pd-0 wow  fadeInUp  animated" data-wow-duration="2.1s" style="visibility: visible; animation-duration: 2.1s; animation-name: fadeInUp;">
                                            <div class="imgs-r">
                                                <figure><img src="img/4_004.png" alt=""></figure>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 pd-0 floatright mr-b30 visible-xs wow  fadeInUp animated animated" data-wow-duration="2.1s" style="visibility: visible; animation-duration: 2.1s; animation-name: fadeInUp;">
                                            <div class="contents-r">
                                                <h2>Online Wallet</h2>
    ...
    <div section-scroll="3" class="wd_scroll_wrap" id="pro">
        <section class="projects bg-img pd-t100 pd-b70 jarallax">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                        <div class="section-heading">
                            <h2 class="wow  fadeInUp  animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">Advantage of the Project</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="project-list wow  fadeInUp  animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">
                            <div class="content">
                                <span class="icons"><img src="img/6.png" alt=""></span>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="project-list wow  fadeInUp  animated" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 1.3s; animation-name: fadeInUp;">
                            <div class="content">
                                <span class="icons"><img src="img/7_002.png" alt=""></span>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="project-list wow  fadeInUp  animated" data-wow-duration="1.6s" style="visibility: visible; animation-duration: 1.6s; animation-name: fadeInUp;">
                            <div class="content">
                                <span class="icons"><img src="img/8.png" alt=""></span>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="project-list wow  fadeInUp  animated" data-wow-duration="1.9s" style="visibility: visible; animation-duration: 1.9s; animation-name: fadeInUp;">
                            <div class="content">
                                <span class="icons"><img src="img/9_002.png" alt=""></span>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="project-list wow  fadeInUp  animated" data-wow-duration="2.1s" style="visibility: visible; animation-duration: 2.1s; animation-name: fadeInUp;">
                            <div class="content">
                                <span class="icons"><img src="img/10.png" alt=""></span>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="project-list wow  fadeInUp  animated" data-wow-duration="2.4s" style="visibility: visible; animation-duration: 2.4s; animation-name: fadeInUp;">
                            <div class="content">
                                <span class="icons"><img src="img/11.png" alt=""></span>
    ...
    <div section-scroll="4" class="wd_scroll_wrap" id="stp">
                    ...
                    <div class="row">
                        <div class="col-lg-11 col-md-11 col-sm-12 col-xs-12">
                            <div class="steps-heading">
                                <h2 class="wow  fadeInUp  animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">Стать партнером</h2>
                                <div class="right-con">
                                    <span>Ваш путь</span>
                ...
                <div class="row">
                    <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 col-md-offset-1 col-lg-offset-1">
                        <div class="steps-cont">
                            <ul>
                                <li class="l-con">
                                    <div class="cont wow  fadeInUp  animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">
                                        <h2>01. Зарегистрироваться на платформе</h2>
                                        <p>Что бы присоединиться к нашей команде, Вам необходимо пройти регистрацию.
                                            <br>Запомните Ваши данные, которые вносили при регистрации, это Важно! </p>
                                    </div>
                                ...
                                <li class="r-con">
                                    <div class="cont wow  fadeInUp  animated" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 1.3s; animation-name: fadeInUp;">
                                        <h2>02. Пройти проверку</h2>
                                        <p>После регистрации Вам нужно пройти проверку, зайдите в свой почтовый ящик и подтвердите регистрацию.
                                            <br>Проверяйте правильность указания Вашего почтового ящика! </p>
                                    </div>
                                ...
                                <li class="l-con">
                                    <div class="cont wow  fadeInUp  animated" data-wow-duration="1.6s" style="visibility: visible; animation-duration: 1.6s; animation-name: fadeInUp;">
                                        <h2>03. Пополнение баланса кабинета</h2>
                                        <p>Что бы начать получать прибыль - Вам необходимо пополнить баланс Вашего кабинета.
                                            <br>После пополнения Ваши деньги сразу поступят в работу. </p>
                                    </div>
                                ...
                                <li class="r-con">
                                    <div class="cont wow  fadeInUp  animated" data-wow-duration="1.9s" style="visibility: visible; animation-duration: 1.9s; animation-name: fadeInUp;">
                                        <h2>04. Получение прибыли</h2>
                                        <p>Прибыль начисляется на ваш счет в кабинете каждые 24 часа.
                                            <br>Начисления происходят в зависимости от времени вашего вклада. </p>
                                    </div>
                                ...
                                <li class="l-con">
                                    <div class="cont wow  fadeInUp  animated" data-wow-duration="2.1s" style="visibility: visible; animation-duration: 2.1s; animation-name: fadeInUp;">
                                        <h2>05. Ваши платежные реквизиты</h2>
                                        <p>Для корректной работы системы, Вам необходимо указать свои данные для выплат.
                                            <br>Вам нужно указать ваши данные во вкладке Кошельки. </p>
                                    </div>
                                ...
                                <li class="r-con">
                                    <div class="cont wow  fadeInUp  animated" data-wow-duration="2.4s" style="visibility: visible; animation-duration: 2.4s; animation-name: fadeInUp;">
                                        <h2>06. Вывод средств</h2>
                                        <p>Для вывода средств создайте заявку во вкладке Опреации - Вывести.
                                            <br>Вывод осуществляется на протяжении 1-3 часов в зависимости от загружености операторов. </p>
                                    </div>
    ...
    <div section-scroll="5" class="wd_scroll_wrap" id="road">
	   ...
	   <center>
        ...
        <div class="sud">
            <svg version="1.1" id="Layer_2" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1920 181.1" style="enable-background:new 0 0 1920 181.1;" xml:space="preserve">
                <style type="text/css">
                    .st0 {
                        fill-rule: evenodd;
                        clip-rule: evenodd;
    ...
    <div section-scroll='6' class="wd_scroll_wrap" id="token">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="section-heading2">
                                <h2 class="wow  fadeInUp animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1.0s; animation-name: fadeInUp;">Инвестиционные пакеты</h2>
                            </div>
                        </div>
                        <div class="col-lg-10 col-md-9 col-sm-12 col-xs-12 col-lg-offset-1 col-md-offset-1">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right wow  fadeInUp animated" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 1.3s; animation-name: fadeInUp;">
                                <div class="tokens mr-l50">
                                    <div class="token-name">PRE-START</div>
                                    <div class="token-body">
                                        <p>План работает 20 дней, без выходных</p>
                                        <button class="left-btn">$50 – $1000</button>
                                        <span class="easypiechart skill-circle">

                                 <span class="percent head-font">2.15</span>
                                        <br>каждые 24 часа
                                        <span class="con"></span>
                                        </span>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right wow  fadeInUp animated" data-wow-duration="1.6s" style="visibility: visible; animation-duration: 1.6s; animation-name: fadeInUp;">
                                <div class="tokens mr-r50">
                                    <div class="token-name">WORKING</div>
                                    <div class="token-body">
                                        <p>План работает 120 дней без выходных</p>
                                        <button class="right-btn">$1001 – $10000</button>
                                        <span class="easypiechart skill-circle">
                                 <span class="percent head-font">6.18</span>
                                        <br>каждые 24 часа
                                        <span class="con"></span>
                                        </span>
                                        <!-- <div class="prices">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                <p class="token-con wow  fadeInUp animated" data-wow-duration="1.9s" style="visibility: visible; animation-duration: 1.9s; animation-name: fadeInUp;">Общая сумма всех депозитов не может привышать 10 000$ <span>без документального оформления. </span>Если вы хотите инвестировать большую сумму, вам необходимо предоставить пакет документов, для этого свяжитесь пожалуйста с поддержкой. </p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="token-details section bg-img">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="section-heading">
                            <h2 class="wow  fadeInUp animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1.0s; animation-name: fadeInUp;">Реферальная система</h2>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-2">
                        <div class="tokes-chart-slider wow animate fadeIn" data-wow-duration="1s">
                            <div class="cart-list">
                                <div class="chart col-sm-6">
                                    ...
                                    <div class="imgs"><img src="images/icons/l.html" alt="" /></div>
                                </div>
                                <div class="col-sm-6">
                        ...
                        <div class="contents text-center">
                            <h2 class="wow  fadeInUp animated" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 1.3s; animation-name: fadeInUp;">Реферальный бонус зависит от общего оборота Вашей структуры.</h2>
													  ...
													  <?php if (_uid()){?>
													   <a href="cabinet" class="btn1 wow  fadeInUp animated" data-wow-duration="1.6s" style="visibility: visible; animation-duration: 1.6s; animation-name: fadeInUp;">ИНВЕСТИРОВАТЬ</a>
													   
													    
            
                    <?php }else{ ?>
      <a href="registration" class="btn1 wow  fadeInUp animated" data-wow-duration="1.6s" style="visibility: visible; animation-duration: 1.6s; animation-name: fadeInUp;">ИНВЕСТИРОВАТЬ</a>
                    <?php }?>
            ...
            <div id="particles-team">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="section-heading2">
                                <h2 class="wow  fadeInUp  animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">Основная команда</h2>
                            </div>
                        </div>
                    </div>
                    <div class="row">
        ...
        <section class="team2-area pd-t100 pd-b50 bg-img">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="section-heading">
                            <h2 class="wow  fadeInUp  animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">Наши консультанты</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
...
more-or-less </p>
        ...
        <div class="sud">
            <svg version="1.1" id="Layer_3" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1920 181.1" style="enable-background:new 0 0 1920 181.1;" xml:space="preserve">
                <style type="text/css">
                    .st0 {
                        fill-rule: evenodd;
                        clip-rule: evenodd;
    ...
    <div section-scroll="7" class="wd_scroll_wrap" id="news">
        
       <section class="media-area section bg-img jarallax" style="background: #10122d;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="section-heading">
                            <h2 class="wow  fadeInUp  animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">Платежные системы <br> (Добавляем новые платежные возможности)</h2>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-2">
                        <div class="mediabrand">
                            <ul>
                                ...
                                <li class="wow  fadeInUp  animated" data-wow-duration="1.6s" style="visibility: visible; animation-duration: 1.6s; animation-name: fadeInUp;">
                                    <a href="#"><img src="img/2_004.png" alt=""></a>
                                </li>
                                <li class="wow  fadeInUp  animated" data-wow-duration="1.9s" style="visibility: visible; animation-duration: 1.9s; animation-name: fadeInUp;">
                                    <a href="#"><img src="img/3_002.png" alt=""></a>
                                </li>
                                ...
                                <li class="wow  fadeInUp  animated" data-wow-duration="2.4s" style="visibility: visible; animation-duration: 2.4s; animation-name: fadeInUp;">
                                    <a href="#"><img src="img/5_003.png" alt=""></a>
                                </li>
                                <li class="wow  fadeInUp  animated" data-wow-duration="2.7s" style="visibility: visible; animation-duration: 2.7s; animation-name: fadeInUp;">
                                    <a href="#"><img src="img/6_003.png" alt=""></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="con">
                                    <h2 class="wow  fadeInUp  animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">Subscribe to us!</h2>
                                    <ul>
                                        ...
                                        <li class="wow  fadeInUp  animated" data-wow-duration="1.5s" style="visibility: visible; animation-name: fadeInUp; animation-duration: 1.5s;"><a href="#"><i class="fa fa-twitter"></i></a></li>
...
<!-- 		
						<div id="supp">
    <h1>Форма поддержки</h1>
    <h2>Заполните форму, чтобы связаться с нами</h2>
<?php if (isset($_GET['done'])){?>

	<h2>Ваш запрос был успешно отправлен!</h2>
	<p class="info">
		Администратор ответит Вам в течение 24 часов
	</p>
<?php }else{ ?>

	<?php echo $_smarty_tpl->getSubTemplate ('message/support.box.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
<?php }?>	
        ...
        <footer class="foo-bot">
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="copyright wow  fadeInUp  animated" data-wow-duration="1.9s" style="visibility: visible; animation-duration: 1.9s; animation-name: fadeInUp;">
                                <p>© 2017-2018 <a href="#"></a>Design by<span> HYIP</span>
                            </p></div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="foo-link wow  fadeInUp  animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">
                                <ul>
    ...
    <script src="js/vc_round_chart.js"></script>
    <script src="js/videojs-ie8.js"></script>
    <script src="js/video.js"></script>
    <script src="js/Youtube.js"></script>
    <!-- main js -->
    <script src="js/main.js"></script><a id="scrollUp" href="#top" style="position: fixed; z-index: 2147483647; display: none;"><i class="fa fa-angle-up"></i></a><div><canvas width="1920" height="1023" style="width: 1920px; height: 1023px;"></canvas><div style="position: fixed; top: 0px; left: 0px; cursor: pointer; opacity: 0.9; z-index: 10000;"><canvas width="80" height="48" style="width: 80px; height: 48px; display: block;"></canvas><canvas width="80" height="48" style="width: 80px; height: 48px; display: none;"></canvas></div></div>


</body>
<!-- Mirrored from themes.hyipsoftware.com/standard-templates/bitmoney/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Sep 2019 05:44:45 GMT -->
</html><?php }} ?>